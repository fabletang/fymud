...
/var flfy_ok 1
/al wim {wi jade}
/al xx {unwi jade;wi needle;wi piece;perform qixingbanyue;perform liantianshuaicao;unwi all;wim}
/al ps {unwi jade;wi needle;wi piece;perform liantianshuaicao;perform qixingbanyue;unwi all;wim}
/al zd {unwi jade;wi needle;wi piece;perform hongouxiangcan;perform qixingbanyue;unwi all;wim}
/al flfy1 {unwi all;wi needle;wi piece;perform fengloufeiyan;perform hongouxiangcan;unwi all;wim}
/al flfy {/if {$flfy_ok==1}{flfy1;/delay {1}{flfy1}}{/showme not 风漏飞烟 }}
/al wkxl {/if {$wkxl_ok==1}{unwi all;wi needle;wi piece;perform wukongxuanliu;unwi all;wim}{/showme not 无空漩流 }}
...
/ac {^你微挪半尺，%1力道尽数落在你身侧冰壁}{/if {$is_kill==1}{flfy}}
