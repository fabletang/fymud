...
/al nhq2dw+ {
    wlk;
    /ac {^ÄÎºÎÇÅ} {fy2nhq-;/ticker {eren}{toucheren}{1};s;/6 east;down};
...
/al fy2zt+ {
    ...
    /ac {Äã¸Ğµ½È«ÉíÎŞ±ÈµÄÊæÌ©} {jump};
    /ac {^Äã´Ó·ãÒ¶ÈªÀïÒ»Ô¾¶øÆğ} {/2 dd leaf;zt2fy;fy2zt-}
}
...
/al fy2ztv+  {
    ...
    /ac {Äã¸Ğµ½È«ÉíÎŞ±ÈµÄÊæÌ©} {wash};
    /ac {^ÄãÀÁÀÁµØ´Ó·ãÒ¶ÈªÀïÕ¾ÆğÉíÀ´} {dd leaf;ztv2fy;fy2ztv-}
}
...
/al fy2nh+ {
    /ac {^ÄãË³×ÅÊ÷¸ËÅÀÁËÉÏÀ´} {/ac {^Ã§ÁÖ±ßÔµ}{su;s;fy2nh-};swing south;de3 {swing south}};
}
/al fy2nh- {
    nwlk;
    /unac {^ÄãË³×ÅÊ÷¸ËÅÀÁËÉÏÀ´};
