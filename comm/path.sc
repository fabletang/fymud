...
/al qf2sq+ {
    wlk;
    /ac {^Ö¨µÄÒ»Éù£¬ÃÅÏòÀï¿ªÁË}{de3 {n;n;qf2sq-}};
...
/al nh2by+ {
    /ac {ÀÏÕÆ¹ñËµµÀ£º¶àĞ»ÕâÎ»}{pl {w;s;e;e;give qiyue to fox;d;/ticker {sail}{sail south}{4};sail south};pr};
    /ac {°×ÔÆ¶É} {nh2by-;s}
}
/al nh2by- {
    nwlk;
...
/al by2nh+ {
    ...
    /nop ac {´¬¼ÒÀÏ²®ÌøÉÏº£°¶}{d;sail north;/ticker {sail}{sail north}{4}};
    /ac {´¬¼ÒÀÏ²®ÌøÉÏº£°¶}{d};
...
/al fy2zt+ {
    ...
    /ac {^ÄãµÄÇ®²»¹»}{fy2zt-};
    /ac {^ÄãÏòĞ¡Ñ¾»·ÂòÏÂÒ»Ìõ°×Ã«½í}{remove all;wear white towel;/3 n;open door;n;jump;wear all};
...
/al fy2ztv+  {
    ...
    /ac {^ÄãµÄÇ®²»¹»}{fy2ztv-};
    /ac {^ÄãÏòĞ¡Í¯ÂòÏÂÒ»Ìõ°×Ã«½í}{remove all;wear white towel;/3 s;open door;s;wash;wear all};
...
/al tx2gw+ {
    ...
    /ac {^²ØÊé¸ó}{w};
    /ac {^É½×¯Ç°Ôº}{s};
    /ac {^´äÖñ×¯ÃÅ}{s;e;e;e;e;e;s;s;s;sd;w;s;e;};
    /ac {^Ñò³¦Ğ¡µÀ}{tx2gw-}
}
/al tx2gw- {
    nwlk;
