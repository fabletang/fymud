...
/ac {^¡¾ÏĞÁÄ¡¿Ìì»úÀÏÈË(Tian ji)£º·çÆğÔÆÓ¿}{/if {$is_walk ==0 }{uptime_do;uptimedo ok}}
...
/ac {ËÀÁË¡£}{look corpse;de2 {get baoxiang;x baoxiang}}
...
/nop ac {^²»ÀÏº®Èª}{/if {$is_kill==0}{gb matong;fill matong;gb skin;fill skin;wi jade;dip jade}}
/unac {^²»ÀÏº®Èª};
...
/ac {^ÄãÎ¸ÀïÒ»Õó½ÊÍ´£¬Á³ÉÏ×ÏÆøÓô½á}{gb pill;de2 {cure malaria}}
/ac {^Â·ĞĞÖÁ´Ë£¬×ÏÄ¢ÁÖÆ®µ´×Åµ­¶øÓÄÏãµÄÎíÕÏ}{gb pill;de2 {cure malaria}}
/ac {^ÄãÖĞµÄÕÎ¶¾¼õÇáÁËÒ»Ğ©}{cure malaria}
/ac {^ÄãÌåÄÚËùÓĞµÄÕÎ¶¾¶¼±»Çå³ıÁË}{pp pill}
/al getshuijing {
...
/ac {^Õ½¶·ÖĞ²»ÄÜ´ò×ø}{iskill}
/nop ac {^== Î´Íê¼ÌĞø%s%1% == (ENTER ¼ÌĞøÏÂÒ»Ò³}{/if {%1<40}{/cr;/cr;/cr;}{/cr;/cr;}}
/ac {^== Î´Íê¼ÌĞø%s%1% == (ENTER ¼ÌĞøÏÂÒ»Ò³}{/cr;}
...
/al digstatue {/ticker {dig}{l ÑîÊ÷;l ĞÂÍÁ;dig;}{4};
/ac {^îõ£®£®µÃÒ»Éù}{new ÍÚµ½Óñ·ğÁË£¬dodge;}
             }
/al notdig {/unticker {dig};/unac {^îõ£®£®µÃÒ»Éù}}
/ac {^ÈıÏÉ±®}{gb skin;fill skin;pp skin}
/var is_fight 0
...
/ac {^ÄãÖĞµÄÆß²Êòùòğ¶¾·¢×÷ÁË}{gb bat drug;de2 {cure 7batpoison};}
